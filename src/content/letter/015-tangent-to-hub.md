...
Why Go? Because the Charm ecosystem is the best terminal UI framework I've encountered, and because Go compiles to a single binary with no runtime dependencies. For a tool that developers need to install and trust, that matters.
